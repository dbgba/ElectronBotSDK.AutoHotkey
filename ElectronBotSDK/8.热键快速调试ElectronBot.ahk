...
姿势.同步姿势(0, 0, 0, 0, 0, 0)
Sleep 100
姿势.同步姿势(15, 0, 0, 0, 0, 0, "test.jpg")  ; 运行脚本点头确保成功连接ElectronBot
Return

F1::姿势.同步姿势(15, 0, 0, 0, 0, 0)  ; 头部上

F2::姿势.同步姿势(0, 0, 0, 0, 0, 0)  ; 头部下

F3::
FileSelectFile, 返回路径, , ,选择ElectronBot的表情, 文件(*.jpg; *.png; *.bmp; *.mp4; *.mov)
表情.播放表情(返回路径)
Return

Up::姿势.同步姿势(0, 0, 0, 180, 0, 0)  ; 左手的抬起

Down::姿势.同步姿势(0, 0, 0, 0, 0, 0)  ; 左手的放下

Left::姿势.同步姿势(0, 0, 0, 0, 0, 180)  ; 右手的抬起

Right::姿势.同步姿势(0, 0, 0, 0, 0, 0)  ; 右手的放下
